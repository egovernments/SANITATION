...
public class Constants {
  ...
  public static final String MDMS_PLANT = "Plant";
  public static final String MDMS_PROCESS = "Process";
  public static final String MDMS_STAGE = "Stage";
  public static final String MDMS_MATERIAL = "Material";
  public static final String PQM_JSONPATH_CODE = "PQM";
