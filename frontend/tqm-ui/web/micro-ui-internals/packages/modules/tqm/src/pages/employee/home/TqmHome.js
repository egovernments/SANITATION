...
const TqmHome = (props) => {
  ...
  const [dateRange, setDateRange] = useState(
    getDateRange({ startDate: startDate.getTime(), endDate: endDate })
  );
  ...
  const { isLoading, data: data1 } = Digit.Hooks.useCustomAPIHook(
    requestCriteria1
  );
  ...
  return (
    <div className='tqm-home-container'>
      ...
      <div
        ...
        style={userNotLinkedToPlant ? { display: 'none' } : {}}
      >
