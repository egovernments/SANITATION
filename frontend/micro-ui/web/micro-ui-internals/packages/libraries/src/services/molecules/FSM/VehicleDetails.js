  ...
  let details = [
    {
      ...
      values: [
        ...
        },
        {
          ...
          value: `COMMON_MASTER_VEHICLE_${data?.type}`,
        },
        ...
        },
        {
          ...
          value:
            data?.pollutionCertiValidTill &&
            Digit.DateUtils.ConvertEpochToDate(data?.pollutionCertiValidTill),
        },
        {
          title: "ES_FSM_REGISTRY_VEHICLE_ROAD_TAX",
          value:
            data?.roadTaxPaidTill &&
            Digit.DateUtils.ConvertEpochToDate(data?.roadTaxPaidTill),
        },
        {
          title: "ES_FSM_REGISTRY_VEHICLE_INSURANCE",
          value:
            data?.InsuranceCertValidTill &&
            Digit.DateUtils.ConvertEpochToDate(data?.InsuranceCertValidTill),
        },
...
const VehicleDetails = async (tenantId, filters = {}) => {
  ...
  const vendorDetails = await FSMService.vendorSearch(tenantId, {
    vehicleIds: id,
  });
