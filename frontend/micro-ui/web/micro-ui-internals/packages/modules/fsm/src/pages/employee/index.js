...
export const FsmBreadCrumb = ({ location, defaultPath }) => {
  ...
  const isModifyApplication = location?.pathname?.includes(
    "modify-application"
  );
  ...
  const pathVar = location.pathname
    .replace(defaultPath + "/", "")
    .split("?")?.[0];
  ...
  const crumbs = [
    ...
    {
      path: isNewApplication
        ? ""
        : `/${window?.contextPath}/employee/fsm/new-application`,
    ...
    },
    {
      path: isInbox
        ? ""
        : isSearch || isApplicationDetails
        ? `/${window?.contextPath}/employee/fsm/inbox`
        : "",
    ...
    },
    {
      path:
        pathVar === "search"
          ? ""
          : `/${window?.contextPath}/employee/fsm/search`,
    ...
    {
      path: isVendorDetails
        ? null
        : `/${window?.contextPath}/employee/fsm/registry/vendor-details/` + id,
      content: t("ES_TITLE_VENDOR_DETAILS"),
      show: isRegistry && (isVendorDetails || isVendorEdit),
    },
    {
      path: isVehicleDetails
        ? null
        : `/${window?.contextPath}/employee/fsm/registry/vehicle-details/` + id,
      content: t("ES_TITLE_VEHICLE_DETAILS"),
      show: isRegistry && (isVehicleDetails || isVehicleEdit),
    },
    {
      path: isDriverDetails
        ? null
        : `/${window?.contextPath}/employee/fsm/registry/driver-details/` + id,
      content: t("ES_TITLE_DRIVER_DETAILS"),
      show: isRegistry && (isDriverDetails || isDriverEdit),
    },
    {
      path: isWorkerDetails
        ? null
        : `/${window?.contextPath}/employee/fsm/registry/worker-details`,
      query: `id=${paramId}`,
    ...
    },
    {
      ...
      show:
        isRegistry &&
        (isVendorEdit || isVehicleEdit || isDriverEdit || isEditWorker),
    },
    {
    ...
    },
    {
      ...
      show:
        isRegistry &&
        (isNewVendor || isNewVehicle || isNewDriver || isAddWorker),
    },
  ];
...
const EmployeeApp = ({ path, url, userType }) => {
  ...
  const NewApplication = Digit.ComponentRegistryService.getComponent(
    "FSMNewApplicationEmp"
  );
  const EditApplication = Digit.ComponentRegistryService.getComponent(
    "FSMEditApplication"
  );
  const EmployeeApplicationDetails = Digit.ComponentRegistryService.getComponent(
    "FSMEmployeeApplicationDetails"
  );
  const FstpOperatorDetails = Digit.ComponentRegistryService.getComponent(
    "FSMFstpOperatorDetails"
  );
  const Response = Digit.ComponentRegistryService.getComponent("FSMResponse");
  const ApplicationAudit = Digit.ComponentRegistryService.getComponent(
    "FSMApplicationAudit"
  );
  ...
  const FSTPO = Digit.UserService.hasAccess(["FSM_EMP_FSTPO"]);
  const FSMRegistry = Digit.ComponentRegistryService.getComponent(
    "FSMRegistry"
  );
  const VendorDetails = Digit.ComponentRegistryService.getComponent(
    "VendorDetails"
  );
  ...
  const VehicleDetails = Digit.ComponentRegistryService.getComponent(
    "VehicleDetails"
  );
  const AddVehicle = Digit.ComponentRegistryService.getComponent("AddVehicle");
  const EditVehicle = Digit.ComponentRegistryService.getComponent(
    "EditVehicle"
  );
  const DriverDetails = Digit.ComponentRegistryService.getComponent(
    "DriverDetails"
  );
  ...
  const BreadCrumbComp = Digit.ComponentRegistryService.getComponent(
    "FsmBreadCrumb"
  );
  ...
  const WorkerDetails = Digit.ComponentRegistryService.getComponent(
    "WorkerDetails"
  );
  const VehicleTrackingCard = Digit.ComponentRegistryService.getComponent(
    "VehicleTrackingCard"
  );
  const VehicleTrackingAlerts = Digit.ComponentRegistryService.getComponent(
    "Alerts"
  );
  const IllegalDumpingSites = Digit.ComponentRegistryService.getComponent(
    "IllegalDumpingSites"
  );
        ...
        <div className="ground-container fsm-ground-container">
          {FSTPO ? (
            <BackButton
              ...
              getBackPageNumber={
                location.pathname.includes("new") ? () => -2 : null
              }
            >
              {t("CS_COMMON_BACK")}
            </BackButton>
          ...
          <PrivateRoute
            exact
            path={`${path}/`}
            component={() => <FSMLinks matchPath={path} userType={userType} />}
          />
          <PrivateRoute
            path={`${path}/inbox`}
            component={() => <Inbox parentRoute={path} isInbox={true} />}
          />
          <PrivateRoute
            path={`${path}/fstp-inbox`}
            component={() => <FstpInbox parentRoute={path} />}
          />
          <PrivateRoute
            path={`${path}/new-application`}
            component={() => <NewApplication parentUrl={url} />}
          />
          <PrivateRoute
          ...
          <PrivateRoute
            path={`${path}/response`}
            component={(props) => <Response {...props} parentRoute={path} />}
          />
          <PrivateRoute
            path={`${path}/application-audit/:id`}
            component={() => <ApplicationAudit parentRoute={path} />}
          />
          <PrivateRoute
            path={`${path}/search`}
            component={() => <FSMSearch />}
          ...
          <PrivateRoute
            ...
            component={() => <RateView parentRoute={path} />}
          />
          <PrivateRoute
          ...
          <PrivateRoute
            exact
            path={`${path}/registry`}
            component={() => <FSMRegistry parentRoute={path} />}
          />
          <PrivateRoute
            path={`${path}/registry/vendor-details/:id`}
            component={() => <VendorDetails parentRoute={path} />}
          />
          <PrivateRoute
            path={`${path}/registry/new-vendor`}
            component={() => <AddVendor parentRoute={path} />}
          />
          <PrivateRoute
            path={`${path}/registry/modify-vendor/:id`}
            component={() => <EditVendor parentRoute={path} />}
          />
          <PrivateRoute
            path={`${path}/registry/vehicle-details/:id`}
            component={() => <VehicleDetails parentRoute={path} />}
          />
          <PrivateRoute
            path={`${path}/registry/new-vehicle`}
            component={() => <AddVehicle parentRoute={path} />}
          />
          <PrivateRoute
            path={`${path}/registry/modify-vehicle/:id`}
            component={() => <EditVehicle parentRoute={path} />}
          />
          <PrivateRoute
            path={`${path}/registry/driver-details/:id`}
            component={() => <DriverDetails parentRoute={path} />}
          />
          <PrivateRoute
            path={`${path}/registry/new-driver`}
            component={() => <AddDriver parentRoute={path} />}
          />
          <PrivateRoute
            path={`${path}/registry/modify-driver/:id`}
            component={() => <EditDriver parentRoute={path} />}
          />
          <PrivateRoute
            exact
            path={`${path}/fstp-operations`}
            component={() => <FstpOperations />}
          />
          <PrivateRoute
            exact
            path={`${path}/fstp-add-vehicle`}
            component={() => <FstpAddVehicle />}
          />
          <PrivateRoute
            exact
            path={`${path}/fstp-fsm-request/:id`}
            component={() => <FstpServiceRequest />}
          />
          ...
          />
          <PrivateRoute
            path={`${path}/registry/new-worker`}
            component={() => <AddWorker parentRoute={path} />}
          />
          <PrivateRoute
            path={`${path}/registry/edit-worker`}
            component={() => <EditWorker parentRoute={path} />}
          />
          <PrivateRoute
            path={`${path}/registry/worker-details`}
            component={() => <WorkerDetails parentRoute={path} />}
          />
          <PrivateRoute
            exact
            path={`${path}/vehicle-tracking/home`}
            component={() => (
              <VehicleTrackingCard matchPath={path} userType={userType} />
            )}
          />
          <PrivateRoute
            path={`${path}/vehicle-tracking/alerts`}
            component={() => (
              <VehicleTrackingAlerts parentRoute={path} isInbox={true} />
            )}
          />
          <PrivateRoute
            path={`${path}/vehicle-tracking/illegal-dumping-sites`}
            component={() => <IllegalDumpingSites />}
          />
        </div>
      </React.Fragment>
    </Switch>
