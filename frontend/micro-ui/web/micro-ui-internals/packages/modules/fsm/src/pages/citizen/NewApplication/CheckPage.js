        ...
        <StatusTable>
          {selectTripNo && selectTripNo?.tripNo && (
            <Row
              ...
              actionButton={
                <ActionButton jumpTo='/sanitation-ui/citizen/fsm/new-application/select-trip-number' />
              }
            />
          )}
          ...
          {selectGender && (
            <Row
              ...
              actionButton={
                <ActionButton jumpTo='/sanitation-ui/citizen/fsm/new-application/select-gender' />
              }
            />
          )}
          <Row
            ...
            actionButton={
              <ActionButton jumpTo='/sanitation-ui/citizen/fsm/new-application/property-type' />
            }
          />
          <Row
            ...
            actionButton={
              <ActionButton jumpTo='/sanitation-ui/citizen/fsm/new-application/property-subtype' />
            }
          />
          <Row
            ...
            actionButton={
              <ActionButton jumpTo='/sanitation-ui/citizen/fsm/new-application/pincode' />
            }
          />
          {address?.landmark?.trim() && (
            <Row
              ...
              actionButton={
                <ActionButton jumpTo='/sanitation-ui/citizen/fsm/new-application/landmark' />
              }
            />
          )}
          {address?.slumArea?.code === true && (
            <Row
              ...
              actionButton={
                <ActionButton jumpTo='/sanitation-ui/citizen/fsm/new-application/slum-details' />
              }
            />
          )}
          {pitType && (
            <Row
              ...
              actionButton={
                <ActionButton jumpTo='/sanitation-ui/citizen/fsm/new-application/pit-type' />
              }
            />
          )}
          {pitMeasurement && (
            <Row
              ...
              text={[pitMeasurement]}
              actionButton={
                <ActionButton jumpTo='/sanitation-ui/citizen/fsm/new-application/tank-size' />
              }
            />
          )}
          {(selectPaymentPreference?.advanceAmount ||
            ...
            <Row
              ...
              actionButton={
                <ActionButton jumpTo='/sanitation-ui/citizen/fsm/new-application/select-payment-preference' />
              }
            />
          )}
        </StatusTable>
