...
const WorkerDetails = (props) => {
  ...
  const { isLoading: ismutateUpdateWorkerLoading, isError: vendorCreateError, data: updateResponse, error: updateError, mutate: mutateUpdateWorker } = Digit.Hooks.fsm.useWorkerUpdate(
    tenantId
  );
