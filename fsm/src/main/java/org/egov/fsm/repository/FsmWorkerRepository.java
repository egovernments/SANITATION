...
import org.egov.fsm.repository.querybuilder.FsmWorkerQueryBuilder;
import org.egov.fsm.repository.rowmapper.FsmWorkerRowMapper;
...
public class FsmWorkerRepository {
    ...
    public WorkerRequest create(WorkerRequest workers) {
