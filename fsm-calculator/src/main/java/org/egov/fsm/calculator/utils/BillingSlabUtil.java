...
public class BillingSlabUtil {
	...
	public String replaceSchemaPlaceholder(String query, String tenantId) {
	    ...
	    if (tenantId.contains(".")) {
	        ...
	        finalQuery = query.replace(CalculatorConstants.SCHEMA_REPLACE_STRING, schemaName);
	    } else {
	        finalQuery = query.replace(CalculatorConstants.SCHEMA_REPLACE_STRING.concat("."), "");
	    }
	    return finalQuery;
	} 
}
